...
public abstract class InputOutputStream
{
   ...
   */
  public abstract int processAttribute(String name, int value) throws IOException, MissingAttributeException,
   ...
   * 		   the attribute should be returned but none can be found
   */
  public abstract double processAttribute(String name, double value) throws IOException, MissingAttributeException,
      MalformedElementException;
   ...
   * 		   the attribute should be returned but none can be found
   */
  public float processAttribute(String name, float value) throws IOException, MissingAttributeException,
      MalformedElementException
  {
   ...
   * 		   the attribute should be returned but none can be found
   */
  public abstract boolean processAttribute(String name, boolean value) throws IOException, MissingAttributeException,
      MalformedElementException;
   ...
   * 		   the attribute should be returned but none can be found
   */
  public abstract String processAttribute(String name, String value) throws IOException, MissingAttributeException,
      MalformedElementException;
   ...
   * @throws IOException if an I/O exception is occured
   */
  public float processAttribute(String name, float value, float defaultValue) throws IOException,
      MalformedElementException
  {
  ...
  */
  ...
  public abstract <T extends Enum<T>> void processEnumChildren(String childName, Map<String, T> children,
      Class<T> enumClass) throws IOException, IXMLStreamableException;
   ...
   * in the TypeRegister.
   */
  public abstract <T extends IXMLStreamable> void processChildren(List<T> children, TypeRegister typeRegister)
      throws IOException, IXMLStreamableException;
   ...
   * in the TypeRegister.
   */
  public abstract <T extends IXMLStreamable> void processChildren(Map<String, T> children, TypeRegister typeRegister)
      throws IOException, IXMLStreamableException;
   ...
   * @throws IXMLStreamableException
   */
  public abstract <T extends IXMLStreamable> T processChild(T value, TypeRegister typeRegister) throws IOException,
      IXMLStreamableException;
   ...
   * @throws IXMLStreamableException
   */
  public abstract <T extends IXMLStreamable> void processInherentChild(String name, T value) throws IOException,
      IXMLStreamableException;
  ...
  */
  ...
  public <T extends Enum<?>> T processEnum(String name, T obj, T defaultValue, Class<T> objClass,
      StorageFormat<T, String> storageFormat) throws MalformedElementException, IOException
  {
  ...
  */
   ...
   * where the exception occurred. Only rarely will the result actually be
   * used, so this should be efficient.
   * 
