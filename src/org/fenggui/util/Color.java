...
public class Color implements IXMLStreamable, Cloneable
{
  ...
  {
    return this.alpha == alpha && this.blue == blue && this.red == red && this.green == green;
  }
  ...
  public void process(InputOutputStream stream) throws IOException, IXMLStreamableException
  {
    ...
    if (stream.isInputStream())
    {
      ...
      if (rgbaStr != null && !rgbaStr.equals(""))
      {
        ...
        if (s.length != 4)
          throw new MalformedElementException("the rgba attribute requires 4 elements, not " + s.length + "!", null);
      ...
      if (!value.equals("no value"))
      {
        ...
        if (color == null)
        {
          throw new MalformedElementException("Color value " + value + " not recognized!", null);
        }
