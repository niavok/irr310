...
public class EventBinding implements KeyListener, MouseMotionListener, MouseListener, MouseWheelListener
{
  ...
  {
    display.fireMouseDraggedEvent(e.getX(), display.getHeight() - e.getY(), EventHelper.getMouseButton(e), e
        .getClickCount());
  }
  ...
  {
    display.fireMouseMovedEvent(e.getX(), display.getHeight() - e.getY(), EventHelper.getMouseButton(e), e
        .getClickCount());
  }
  ...
  public void mouseClicked(MouseEvent e)
  {
    if (e.getClickCount() % 2 == 0)
      display.fireMouseDoubleClickEvent(e.getX(), display.getHeight() - e.getY(), EventHelper.getMouseButton(e), e
          .getClickCount() / 2);
    else
      display.fireMouseClickEvent(e.getX(), display.getHeight() - e.getY(), EventHelper.getMouseButton(e), e
          .getClickCount());
  ...
  {
    display.fireMousePressedEvent(e.getX(), display.getHeight() - e.getY(), EventHelper.getMouseButton(e), e
        .getClickCount());
  }
  ...
  {
    display.fireMouseReleasedEvent(e.getX(), display.getHeight() - e.getY(), EventHelper.getMouseButton(e), e
        .getClickCount());
  }
  ...
  {
    display.fireMouseWheel(e.getX(), display.getHeight() - e.getY(), e.getWheelRotation() < 0, Math.abs(e
        .getWheelRotation()), e.getScrollAmount());
  }
