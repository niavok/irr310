...
public class Graphics {
     ...
     * </p>
     * 
     * @param x The x-coordinate of the left hand side of the clipping area
     * @param y The y-coordinate of the top of the clipping area
     ...
     * @param tex The Texture you wish to draw
     * @param x The x coordinate you wish to place it at
     * @param y The y coordinate you wish to place it at
     * @param width The width you want to scale the Texture to
     * @param height The height you want to scale the Texture to
     */
     ...
     * 
     * @param gl The OpenGL object we will be rendering via.
     */
     ...
     * @param x The x position of the string to render
     * @param y The y position of the string to render
     **/
    ...
    public void drawWireRectangle2(int x, int y, int width, int height, float weigth) {
        // Bottom left
        float bl0x = x + offset.getX() - weigth / 2;
        float bl0y = y + offset.getY() - weigth / 2;

        float bl1x = x + offset.getX() + weigth / 2;
        float bl1y = y + offset.getY() + weigth / 2;

        // Top left
        float tl0x = x + offset.getX() - weigth / 2;
        float tl0y = y + offset.getY() + weigth / 2 + height;

        float tl1x = x + offset.getX() + weigth / 2;
        float tl1y = y + offset.getY() - weigth / 2 + height;

        // Top right
        float tr0x = x + offset.getX() + weigth / 2 + width;
        float tr0y = y + offset.getY() + weigth / 2 + height;

        float tr1x = x + offset.getX() - weigth / 2 + width;
        float tr1y = y + offset.getY() - weigth / 2 + height;

        // Bottom right
        float br0x = x + offset.getX() + weigth / 2 + width;
        float br0y = y + offset.getY() - weigth / 2;

        float br1x = x + offset.getX() - weigth / 2 + width;
        float br1y = y + offset.getY() + weigth / 2;
     ...
     * @param resolution The resolution (number of steps to the rounded corner)
     */
     ...
     * 
     * @param x X coordinate of left hand side of rectangle
     * @param y Y coordinate of top of rectangle
     * @param width The width of the rectangle
     * @param height The height of the rectangle
     * @param radius The radius of the corner smoothing
     */
