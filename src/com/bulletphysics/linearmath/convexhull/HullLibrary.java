...
public class HullLibrary {
	...
	private boolean cleanupVertices(int svcount,
		...
		double[] bmin = new double[] { Float.MAX_VALUE, Float.MAX_VALUE, Float.MAX_VALUE };
		double[] bmax = new double[] { -Float.MAX_VALUE, -Float.MAX_VALUE, -Float.MAX_VALUE };
		...
		//	if ( 1 )
		{
			bmin = new double[] { Float.MAX_VALUE, Float.MAX_VALUE, Float.MAX_VALUE };
			bmax = new double[] { -Float.MAX_VALUE, -Float.MAX_VALUE, -Float.MAX_VALUE };
