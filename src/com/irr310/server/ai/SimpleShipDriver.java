...
public class SimpleShipDriver {
    ...
    private int lastDeltaSpeed;
    private double optimalPower;
    private int lastSpeedTarget;
    ...
    private void processEngines() {
        ...
        double maxThrust = Math.min(leftEngine.getMaxThrust(), rightEngine.getMaxThrust());
        ...
        double maxHorizontalThrust = Math.min(leftEngine.getMaxThrust(), rightEngine.getMaxThrust());
        double minHorizontalThrust = Math.min( -leftEngine.getMinThrust(), -rightEngine.getMinThrust());
        double maxVerticalThrust = Math.min(topEngine.getMaxThrust(), bottomEngine.getMaxThrust());
