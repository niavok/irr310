...
public class ProductionManager {
    ...
    public void doRound(FactionProduction production) {
    ...
    void checkCapacityIncrease(FactionProduction production) {
        ...
        production.setNextFactoryCapacityIncreaseRounds(production.getNextFactoryCapacityIncreaseRounds() - 1);
        
        if(production.getNextFactoryCapacityOrder() != null) {

            // Check delay expire
            if(production.getNextFactoryCapacityIncreaseRounds() < 0) {
                // Increase capacity
                ...
                production.setNextFactoryCapacityIncreaseRounds(FactionProduction.FACTORY_CAPACITY_INCREASE_DELAY);
            }
        }
    }
    
    public void buyFactoryCapacity(FactionProduction production, long count) {
    ...
    public void sellFactoryCapacity(FactionProduction production, long count) {
