...
public class Gui {
	...
	public GuiRectangle createRectangle() {
	    ...
	    GameClient.getInstance().getGraphicEngine().getRenderer().addGuiComponent(component);
        return guiRectangle;
	}
	...
	public void destroyComponent(GuiComponent guiComponent) {
	    ...
	    GameClient.getInstance().getGraphicEngine().getRenderer().removeGuiComponent(component);
	}
