...
public class MonolithSkin extends Skin {
    ...
    public MonolithSkin(WorldRenderer renderer, final CelestialObject object) {
        ...
        elements.add(new V3DColorElement(new V3DShaderElement(element, "propeller"), new I3dColor(20, 20, 20)));
        ...
        elements.add(new V3DColorElement(new V3DShaderElement(elementArmature, "propeller"), new I3dColor(135, 158, 169)));
        ...
        elements.add(new V3DColorElement(new V3DShaderElement(elementPlasma, "plasma"), new I3dColor(151, 32, 153, 0.3f)));
